...
- [ ] Pre-Implementation: Audit existing components against ai-frontend-prompt.md checklist
  - [ ] Document specific deviations per component in audit report using standardized format:
    ```markdown
    ...
    **Priority Definitions:**
    ...
    ```
  - [ ] Prioritize fixes (critical vs. nice-to-have) using audit report Priority column
  - [ ] Estimate effort per component using audit report Effort Estimate column
  - [ ] Validate total effort estimate aligns with story estimate (12-16 hours)
...
- [ ] Refine Duplicate Detection component (Story 2.5)
  - [ ] Review current implementation in `src/Ledgerly.Web/src/app/features/import/duplicate-warning-dialog.component.ts`
  - [ ] Implement side-by-side comparison view layout
  - [ ] Add confidence badges (Green=exact, Yellow=likely, Gray=uncertain)
  - [ ] Highlight differences in yellow
  - [ ] Implement action buttons: "Skip This", "Import Anyway", "Skip All Remaining"
  - [ ] Test keyboard navigation through comparison list
...
- [ ] Cross-cutting improvements
  ...
  - [ ] Implement focus indicators (2px teal outline) using CSS custom properties
